Feature: Driver Registration
  ...
  Scenario Outline: Account Creation
    ...
    Examples:
      ...
      | "John"         | "Smith"   | "12345678"  | "35"       | "3121234567"          | "john@example.com"      | "1"      | "khg365" | "Toyota" | "Hilux" | "black" | "PICKUP" | 1000.0        | 201  |
      | "Mary"         | "Lee"     | "98765432"  | "27"       | "3152345678"          | "mary@example.com"      | "2"      | "ahg365" | "Toyota" | "Hilux" | "blue"  | "PICKUP" | 2000.0        | 201  |
      | "John"         | "Smith"   | "12345678"  | "35"       | "3156789012"          | "johnsmith@example.com" | "6"      | "bhg365" | "Toyota" | "Hilux" | "blue"  | "PICKUP" | 2000.0        | 400  |
      | "John"         | "Smith"   | "123456789" | "35"       | "3207890123"          | "johnsmith@example.com" | "7"      | "chg365" | "Toyota" | "Hilux" | "blue"  | "PICKUP" | 2000.0        | 201  |
