Feature: Driver Registration
  ...
  Scenario Outline: Account Creation
    ...
    Examples:
      ...
      | "Sara"     | "Restrepo"  | "2179052435"   | "35" | "3121234567" | "saralopezjob2@cargo.com"    | "1"      | "ara505" | "Toyota" | "Hilux" | "black" | "PICKUP" | 1000.0        | 201  | ""                                   |
      ...
      | "Andrea"   | "Lee"       | "756202331012" | "25" | "3207890123" | "andrelee2@example.com"      | "7"      | "BBB169" | "Toyota" | "Hilux" | "blue"  | "PICKUP" | -2000.0       | 201  | ""                                   |
      | "Andres"   | "Serna"     | "94066202331"  | "25" | "3207890123" | "anser200ha@mail.com"        | "7"      | "bbb169" | "Toyota" | "Hilux" | "blue"  | "PICKUP" | 2000.0        | 201  | ""                                   |
